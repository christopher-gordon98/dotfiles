...
# c.InteractiveShell.banner1 = 'Python 3.5.2 (default, Oct 11 2016, 04:59:56) \nType "copyright", "credits" or "license" for more information.\n\nIPython 5.1.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
# The name of a Pygments style to use for syntax highlighting:  colorful,
# friendly, paraiso-dark, monokai, igor, perldoc, borland, algol, native, manni,
# paraiso-light, tango, lovelace, rrt, pastie, xcode, emacs, autumn, default,
# fruity, trac, murphy, vim, bw, vs, algol_nu
