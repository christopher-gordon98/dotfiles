source /usr/local/Cellar/cabal-install/1.24.0.0_2/etc/bash_completion.d/cabal
source /usr/local/Cellar/flow/0.34.0/etc/bash_completion.d/flow-completion.bash
...
source /usr/local/Cellar/node/7.0.0/etc/bash_completion.d/npm
...
source /usr/local/Cellar/tmux/2.3_1/etc/bash_completion.d/tmux
