...
#cloud at a cost
alias sshcc='ssh root@104.167.102.179'

alias ssheb='ssh user_19936432@ssh.estruch-notebook.co.uk'
alias rasgi='ssh gi@192.168.0.6'
alias raspi='ssh pi@192.168.0.6'
alias sshmb='ssh sambuser@192.168.0.4'
